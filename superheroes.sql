...
INSERT INTO heroes (name, about_me, biography) VALUES (
    'Lidar Man',
    "Born without the ability to see, but with the ability to detect a lie no matter how small.", 
    "Lidar Man learned to use his ears as a child to detect lies. One day he was hit with an intense ray of gamma radiation and the only way the doctors could fix him was to add nanotech robots into his brain."
    );
